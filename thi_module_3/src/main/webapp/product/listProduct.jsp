...
<div class="container">
    ...
    <div class="row">
        <div class="col-lg-4"><a href="/product?action=create" class="btn btn-success">Create Customer</a></div>
        <div class="col-lg-8 align-items-lg-end">
                    <form action="/product" class="d-flex justify-content-lg-end">
                        ...
                        <input class="form-control me-2 w-50" type="text" placeholder="SearchAddress"
                               name="keyAddress" value="${keyPrice}" aria-label="Search">
    ...
    <table class="table table-hover" id="myTable">
        ...
        <c:forEach var="product" items="${productList}">
            <tr>
                ...
                <td>
                    <a href="/product?action=update&id=${product.id}" class="btn btn-warning">Update</a>
                </td>
                <td>
                    <button onclick="infoToModal('${product.id}','${product.productName}')" class="btn btn-danger"
